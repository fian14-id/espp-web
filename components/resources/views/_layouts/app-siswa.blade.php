<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="light-style layout-navbar-fixed layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="/assets/" data-template="pembayaran-spp" data-type="siswa">
  <head>
    <meta charset="utf-8" />
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{ route('sis.dash') }}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="{{ route('pby.siswa.history') }}" class="menu-link">
                <i class="menu-icon tf-icons ti ti-file-description"></i>
                <div data-i18n="Histori Pembayaran">Histori Pembayaran</div>
              </a>
            </li>
          </ul>
        </aside>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-muted">{{ auth()->user()->nisn }}</small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ route('sis.profil', ['nisn' => auth()->user()->nisn ]) }}">
                        <i class="ti ti-user-check me-2 ti-sm"></i>
                        <span class="align-middle">Profil Saya</span>
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="{{ route('sis.edit') }}">
